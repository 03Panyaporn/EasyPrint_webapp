...
CREATE TABLE IF NOT EXISTS "order_items" (
	...
	"pricing_type_snapshot" "pricing_model" NOT NULL,
	"base_price_snapshot" numeric(10, 2) NOT NULL,
	"quantity" integer DEFAULT 1 NOT NULL,
	"options_snapshot_json" jsonb,
	"additional_services_snapshot_json" jsonb,
	"file_url" text,
	"page_count" integer,
...
ALTER TABLE "orders" ADD COLUMN "total_price_snapshot" numeric(10, 2);--> statement-breakpoint
