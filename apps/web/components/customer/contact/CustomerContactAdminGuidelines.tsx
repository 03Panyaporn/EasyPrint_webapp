...
export default function CustomerContactAdminGuidelines() {
  return (
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1 leading-relaxed">
              อธิบายปัญหาให้ละเอียด เช่น หมายเลขคำสั่งซื้อ หรือชื่อร้านค้า เพื่อให้ทีมงานช่วยเหลือได้รวดเร็วขึ้น
            </p>
          </div>
        </div>
