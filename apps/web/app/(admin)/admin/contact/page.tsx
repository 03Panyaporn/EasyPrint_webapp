...
export const metadata: Metadata = { title: "ติดต่อสอบถาม" };

export default function ContactPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center gap-4">
      <div className="w-20 h-20 bg-orange-100 rounded-2xl flex items-center justify-center">
        <PhoneCall size={36} className="text-orange-500" />
      </div>
      <div>
        <h1 className="text-2xl font-bold text-gray-900">ติดต่อสอบถาม</h1>
