    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-6 sm:space-y-8">
        ...
        <div ref={shopListRef} className="space-y-3 scroll-mt-20">
          ...
          <div
            className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 bg-white p-4 rounded-2xl shadow-xs border border-slate-100 transition-all ${
          ...
          >
            ...
            {activeFilterCount > 0 && (
              <div className="sm:col-span-2 lg:col-span-3 pt-2 border-t border-slate-100 flex justify-end">
                <button
