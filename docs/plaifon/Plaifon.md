...
### 5. สิ่งที่ยังไม่ได้ทำ (ตั้งใจเว้นไว้ มี TODO กำกับในโค้ด)

* **Auth/JWT** — endpoint แก้ไข/ลบยังไม่เช็คว่าผู้เรียกเป็นเจ้าของร้านจริง ตอนนี้กันได้แค่ "shopId ผิด → 404" แต่ไม่กันคนที่ปลอมแปลง shopId ที่ถูกต้องของร้านอื่น **ต้องทำก่อนขึ้น production**
